...
namespace Autisid\OpenIDConnect;
...
use Autisid\OpenIDConnect\Traits\Authorization;
use Autisid\OpenIDConnect\Traits\AutoDiscovery;
use Autisid\OpenIDConnect\Traits\DynamicRegistration;
use Autisid\OpenIDConnect\Traits\ImplictFlow;
use Autisid\OpenIDConnect\Traits\JWT;
use Autisid\OpenIDConnect\Traits\Token;
...
class Client
{
    ...
    public function endpoints(
        ...
        #[ArrayShape([
            ...
            'token_endpoint_auth_methods_supported' => 'Autisid\OpenIDConnect\ClientAuthMethod[]',
        ])] array $options = []
    ): self {
